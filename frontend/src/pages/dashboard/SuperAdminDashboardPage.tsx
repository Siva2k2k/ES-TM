...
import { DashboardService, type SuperAdminDashboardData } from '../../services/DashboardService';
import { toast } from 'react-toastify';

/**
 * SuperAdmin Dashboard Page
 * Fetches data and renders the SuperAdminDashboard component
...
export const SuperAdminDashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        setLoading(true);
        const { dashboard, error } = await DashboardService.getSuperAdminDashboard();
